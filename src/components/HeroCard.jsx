      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 910 606" width="910" height="606">
        ...
        <g id="centerPanel">
          ...
          <g id="middleOfTurn">
            ...
            {/* Move icon (simplified boot/path) */}
            <g transform="translate(320,132)" color="#c4a882">
              <path d="M4,18 L12,2 L20,18" fill="none" stroke="#c4a882" strokeWidth="2" strokeLinejoin="round"/>
              <path d="M2,18 L22,18" stroke="#c4a882" strokeWidth="1.5"/>
            </g>
